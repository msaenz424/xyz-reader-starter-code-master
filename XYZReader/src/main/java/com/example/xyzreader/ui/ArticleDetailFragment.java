...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        final Toolbar mToolbar = (Toolbar) mRootView.findViewById(R.id.toolbar_detail);
        final CollapsingToolbarLayout  mCollapsingToolbarLayout = (CollapsingToolbarLayout) mRootView.findViewById(R.id.toolbar_layout_detail);
        ...
        if (mCursor != null) {
            ...
            Spanned spannedBody = Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY).replaceAll("(\r\n|\n)", "<br />"));
            bodyView.setText(spannedBody);
            ImageLoaderHelper.getInstance(getActivity()).getImageLoader()
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                // Asynchronous task to generate palette
    ...
    /**
     * Resumes the transition animation that was previously postponed
     *
     * @param sharedElement the shared view that will be animated
     */
